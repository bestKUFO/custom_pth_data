...
def train(opt):
    ...
    if 'CTC' in opt.Prediction:
        if opt.baiduCTC:
            ...
            from warpctc_pytorch import CTCLoss  # type: ignore
            criterion = CTCLoss()
        else:
...
if __name__ == '__main__':
    ...
    """ Data processing """
    parser.add_argument('--select_data', type=str, default='/', #default=MJ-ST
                        help='select training data (default is MJ-ST, which means MJ and ST used as training data)')
    parser.add_argument('--batch_ratio', type=str, default='1', #default=0.5-0.5
    ...
    # 여기 default=True 추가함(원래 안들어가있었음)
